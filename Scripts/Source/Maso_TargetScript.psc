ScriptName Maso_TargetScript Extends ReferenceAlias
...
Event OnHit(ObjectReference akAggressor, Form akSource, Projectile akProjectile, Bool abPowerAttack, Bool abSneakAttack, Bool abBashAttack, Bool abHitBlocked)
	...
	If (newHealth < Health)	&& (StorageUtil.GetIntValue(Me, SpecialKey, 0) != 1)
		...
		;NPC Sadism
		ElseIf (akAggressor as Actor) && StorageUtil.GetIntValue(akAggressor as Actor, SadoKey, 0) == 1 && ((config.bNPCSadism) || StorageUtil.GetIntValue(akAggressor as Actor, SpecialKey, 0) == 1)
		...
		;NPC Masochism
		If((config.bNPCMasochism || StorageUtil.GetIntValue(akAggressor as Actor, SpecialKey, 0) == 1) && StorageUtil.GetIntValue(Me, MasoKey, 2) == 1)
